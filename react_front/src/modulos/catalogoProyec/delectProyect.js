                    ...
                    <section className="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
                        ...
                        <form>
                            ...
                            <div className="flex justify-end mt-6">
                                <button id="delectProyect" onClick={(e) => delectProyect(e)} className="px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">Eliminar</button>
                            </div>
                        </form>
                    </section>  
                </div>
