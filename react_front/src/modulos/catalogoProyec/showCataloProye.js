...
const ShowCataloPro = () => {
    ...
    <>
        <div className="divCont bg-neutral-200 dark:bg-neutral-700 justify-center items-center h-screen">
            ...
            {dataCatPro.map( doc => {
                    return  <div className="lg:m-auto sm:m-6 h-auto w-auto rounded-lg bg-gray-200">
                    <article className="h-auto w-auto hover:animate-background rounded-lg bg-gradient-to-r from-blue-700 via-blue-800 to-blue-900 p-0.5 shadow-xl transition hover:bg-[length:400%_400%] hover:shadow-sm hover:[animation-duration:_4s]">
                        <div className="rounded-[10px] bg-slate-950 p-4 !pt-20 sm:p-6">
                            ...
                            <div className="mt-4 flex flex-wrap gap-1">
                                <div className="grid grid-cols-1 gap-5 lg:grid-cols-3 lg:gap-4">
                                    <button id="proyectUpdate" onClick={ () => navigate(`/CatalogoProy/update/${ doc.id }`)} className="h-full w-full p-auto m-auto bg-slate-950 hover:bg-blue-950 text-white font-bold py-2 px-4 rounded ">
                                        <svg  className="h-5 w-5 text-slate-600"  width="24"  height="24"  viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round">  <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" />  <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" /></svg>
                                    </button>
                                    <button id="proyectDelect" onClick={ () => navigate(`/CatalogoProy/delect/${ doc.id }`) } className="h-full w-full p-auto m-auto bg-slate-950 hover:bg-blue-950 text-white font-bold py-2 px-4 rounded ">
                                    ...
                                    <button id="showProyect" onClick={ () => navigate(`/CatalogoProy/showProyect/${ doc.id }`) } className="h-full w-full p-auto m-auto bg-slate-950 hover:bg-blue-950 text-white font-bold py-2 px-4 rounded ">
