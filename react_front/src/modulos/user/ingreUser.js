...
const IngreUser = () => {
    ...
    return(<>
        <div className="divCont bg-blue-950 justify-center items-center h-screen scrollbar scrollbar-thumb-slate-900" style={{ overflow: "auto" }}>
                                        ...
                                        <div className="md:mx-6 md:p-12">
                                            ...
                                            <form>
                                                ...
                                                <div className="mb-12 pb-1 pt-1 text-center">
                                                    <button className="mb-3 inline-block w-full rounded px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-dark-3 transition duration-150 ease-in-out hover:shadow-dark-2 focus:shadow-dark-2 focus:outline-none focus:ring-0 active:shadow-dark-2 dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong" type="button" style={{background: "linear-gradient(to right, rgb(2 6 23 / var(--tw-bg-opacity)), rgb(2 6 23 / var(--tw-bg-opacity)), #071c35, #051e3b)"}}>
                                                        log in
                                                    </button>
